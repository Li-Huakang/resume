...
有扎实的电气和电力电子专业知识基础，
擅长物理建模和数学分析。
硕士论文课题从事功率半导体器件和模块的研究，
了解半导体物理学，熟悉功率半导体失效与退化机理，专攻功率半导体结温监测和健康状态监测。
熟悉计算机科学，有一定的软硬件开发经验。
对新知识有良好的学习吸收能力。
希望从事功率器件应用和电源技术开发的工作。
\par}
...
\begin{itemize}
  ...
  \item \textbf{功率半导体模块健康状态管理研究}\\
  {\small 1.调研功率半导体模块失效机理和主要失效模式并确定先兆参数；
  2.讨论基于数据驱动和故障物理的健康状态监测方案。}
\end{itemize}
